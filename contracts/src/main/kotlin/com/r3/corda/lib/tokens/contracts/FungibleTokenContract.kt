...
open class FungibleTokenContract : AbstractTokenContract<FungibleToken>() {
    ...
    override fun verifyIssue(
            ...
            inputs: List<AbstractTokenContract.IndexedState<FungibleToken>>,
            outputs: List<AbstractTokenContract.IndexedState<FungibleToken>>,
    ...
    override fun verifyReissue(reissueCommand: CommandWithParties<TokenCommand>,
